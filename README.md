...
local vitorhubkaitun = Instance.new("ScreenGui")
...
vitorhubkaitun.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
vitorhubkaitun.Name = "vitorhubkaitun"
vitorhubkaitun.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Frame.Parent = vitorhubkaitun
...
Brand.Text = "catn1qqer x vitor hub"
...
LogoName.Text = "vitor hub Kaitun"
...
ToggleUIButton.Parent = vitorhubkaitun
...
ToggleUIButton.MouseButton1Click:Connect(function()
    ...
    if toggleState then
        ...
        game:GetService("Players").LocalPlayer.PlayerGui.vitorhubkaitun.Frame.Visible = true
    else
        ToggleUIButton.Text = "open"
        game:GetService("Players").LocalPlayer.PlayerGui.vitorhubkaitun.Frame.Visible = false
    end
end)
