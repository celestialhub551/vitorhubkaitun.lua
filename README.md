...
local KaitunvitorhubGUI = Instance.new("ScreenGui")
...
KaitunvitorhubGUI.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
KaitunvitorhubGUI.Name = "KaitunvitorhubGUI"
KaitunvitorhubGUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Frame.Parent = KaitunvitorhubGUI
...
Main.ZIndex = 0
Main.Image = "rbxassetid://73846805101946"
...
LogoName.Text = "VITOR HUB KAITUN V1"
...
ToggleUIButton.Parent = KaitunvitorhubGUI
...
ToggleUIButton.MouseButton1Click:Connect(function()
    ...
    if toggleState then
        ...
        game:GetService("Players").LocalPlayer.PlayerGui.KaitunvitorhubGUI.Frame.Visible = true
    else
        ToggleUIButton.Text = "open"
        game:GetService("Players").LocalPlayer.PlayerGui.KaitunvitorhubGUI.Frame.Visible = false
    end
end)
